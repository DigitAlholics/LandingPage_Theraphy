...
function yousendit(){
    if(document.getElementById('yousendit').checked){
        window.location='https://digitalholics.github.io/LandingPage_Theraphy/index-spanish.html';
        return false;
    }
    return true;
...
function yousendit2(){
    if(document.getElementById('yousendit2').checked){
        window.location='https://digitalholics.github.io/LandingPage_Theraphy/index.html';
        return false;
    }
    return true;
